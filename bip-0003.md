...
backward-compatible way and for status updates. The PATCH version is incremented for other backward-compatible changes to the BIP that are noteworthy (bug fixes,
